...
public class CommandTime implements CommandCallable {
	...
	private final Text usage = Text.builder("Usage: /time <day|night|sunrise|sunset> [world]").color(TextColors.YELLOW).build();
	private final Text help = Text.builder("Help: /time <day|night|sunrise|sunset> [world]").color(TextColors.YELLOW).build();
