...
public class CommandFakeleave implements CommandCallable {
	...
	public CommandResult process(CommandSource sender, String arguments) throws CommandException {
		...
		if(!PERMISSIONS.has(sender, "core.fakeleave")) { sender.sendMessage(Texts.builder("You do not have permissions!").color(TextColors.RED).build()); return CommandResult.success(); }
		...
		Controller.broadcast(TEXT.color(MESSAGES.EVENTS_LEAVE_MESSAGE().replaceAll("%player", name)));
